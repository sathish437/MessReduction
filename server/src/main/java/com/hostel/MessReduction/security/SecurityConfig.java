    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/staff/validate").permitAll()
                        .requestMatchers("/v3/api-docs/**").permitAll()
                        .requestMatchers("/swagger-ui/**").permitAll()
                        .requestMatchers("/swagger-ui.html").permitAll()
                        .requestMatchers("/api/hostelStaff/staff/warden/**").hasRole("WARDEN")
                        .requestMatchers("/api/hostelStaff/staff/deputyWarden/**").hasRole("DEPUTY_WARDEN")
                        .requestMatchers("/api/hostelStaff/staff/office/**").hasRole("OFFICE")
                        .requestMatchers("/api/hostelStaff/staff/dashboard-count").hasAnyRole("WARDEN", "DEPUTY_WARDEN", "OFFICE")
                        .requestMatchers("/api/hostelStaff/staff/deputyWarden/year-count").hasRole("DEPUTY_WARDEN")
